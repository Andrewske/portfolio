  ...
  return (
    <section className="mb-12">
      <div className="border border-gray-800 rounded-lg overflow-hidden">
        <div className="flex">
          <div className="hidden sm:block w-12 sm:w-16 bg-gray-900 flex-col items-center py-6 text-gray-600 text-sm"></div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-2 sm:gap-4">
              {project.metrics.map((metric, index) => (
                <div
                  ...
                  className="text-center p-2 sm:p-3 md:p-4 bg-gray-900/50 rounded border border-gray-800"
                >
